...
// ------------------------------------------------------------------------ 
    ...
    require([
	  ...
	  "esri/symbols/TextSymbol",    //added extra 
      "dojo/domReady!"
    ], function(
      Map, MapView,
	  ...
	  // Create a text label at the Gulf's location (extra)
	 ...
	 */
	 /*
	 var polyGrapHFO = new Graphic({
        geometry: polyHFO,
        symbol: fillSymbol,
        popupTemplate: { // autocasts as new PopupTemplate()
          content: [{
            type: "text",
            text: "<p><strong>WFO Honolulu, Hawaii</strong></p><p><a href=http://polar.ncep.noaa.gov/nwps/nwpsloop.php?site=HFO&cg=1 target=_blank>Model Field Animations</p>",
          }]
        }
      });
	  */
	 
	 //old option starts here
